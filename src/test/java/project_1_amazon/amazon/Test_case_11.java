...
public class Test_case_11 extends Basee_class
{

	
	@Test(retryAnalyzer=Retry_logic.class)
	public void testt_casee_11() throws InterruptedException
	{
		...
		cart.use_this_payment_method_m();
		cart.delivery_address_present_m();
